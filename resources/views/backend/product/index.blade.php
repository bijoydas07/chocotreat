...
<div class="card mb-4">
    ...
    <div class="card-header" style="background-color: #cca3ff;">
        ...
        <a href="{{ route('products.trash')}}" class="btn trash-btn btn-sm" style="background-color: #e933b9;
        color: white;">Trash List</a>
        <x-slot:title>
        Product List
        </x-slot>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="delete-btn d-inline" action="{{ route('products.destroy',['product'=>$product->id])}}" method="post">
                            @method('delete')
                            @csrf
                            <button onclick="alert('Are you sure to delete this product!')" class="btn btn-danger" type="submit"><i class="fa-solid fa-trash"></i></button>
                        </form>
                    </td>
                </tr>
                @endforeach
